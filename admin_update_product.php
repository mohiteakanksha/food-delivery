...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="fruits">Snaks</option>
         <option value="meat">Chaniess</option>
         <option value="fish">Nonveg meal</option>   
         <option value="fish">Veg meal</option>
         <option value="fish">Sweets</option>
         <option value="fish">Bakery product</option>
